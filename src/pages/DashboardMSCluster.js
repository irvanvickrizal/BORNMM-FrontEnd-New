...
const DashboardMSCluster = () => {
    ...
    return (
        <>
            ...
            {isLoading ? (<div style={{position:"absolute",zIndex:3 ,height:"100%",width:"100%",}} align="middle" justify="center">
                <PageLoading/>
            </div>):(null)}
...
export default DashboardMSCluster;
