...
export default function MaterialOrder() {
    ...
    const [parentOrderDetailId,setParentOrderDetailId] = useState('')
    ...
    const getOrderDetail=(odi)=>{
        API.getOrderDetailForm(odi).then(
            result=>{
                ...
                setParentOrderDetailId(result[0].parentOrderDetailId)
    ...
    const getOrderDetailMaterial=(podi)=>{
        setIsOutOfStock(0);
        API.getMaterialOrderSDRLTR(podi).then(
            result=>{
            ...
            API.deleteMaterialOrderRequest(data.orderMaterialId).then(
                result=>{
                    if(result.status=="success"){
                        ...
                        getOrderDetailMaterial(parentOrderDetailId);
                    }
                    else{
