                ...
                <table id="tblScope" className="display table table-striped table-bordered table-sm row-border hover mb-5 responsive" aria-labelledby="tabelLabel">
                    ...
                    <tbody>
                        {subCategoryData.map(sct => <tr key={sct.subCategoryId}>
                            ...
                            <td>
                                {sct.isEditRow == null ? sct.subCategoryCode :
                                    <input placeholder={sct.subCategoryCode} onChange={(e) => setSubCategoryCode(e.target.value)} type="text" class="form-control col-md-9" aria-label="Username" aria-describedby="basic-addon1" />}
                            </td>
                            <td>
